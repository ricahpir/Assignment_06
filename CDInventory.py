...
# ricahpir, 2030-Jan-01, Edited File
...
class IO:
    ...
    def del_row(table):
        ...
        iterates data in lstTbl based on intIDDel, which is the variable defined user input
        finds the dicRow corresponding with intIDDel, then deletes the corresponding dicRow.
       
        Args:
            None.

        Returns:
            intIDDel(int): a number the user provides to delete the appropriate dicRow.
